...
class ImageGenPrompt(Base):
    ...
    category: Mapped[str] = mapped_column(String(32), nullable=False, default="", comment="职业分类：健康教练/运营/开发/管理层")
    cover_url: Mapped[str] = mapped_column(String(512), nullable=False, default="", comment="封面图 URL（七牛）")
