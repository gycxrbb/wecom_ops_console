...
<style scoped>
.ai-thinking-box { margin-bottom: 12px; padding: 10px 14px; border-radius: 12px; background: #f8fafc; border: 1px dashed #e5e7eb; max-width: 100%; }
.ai-thinking-box__header { display: flex; align-items: center; gap: 6px; margin-bottom: 6px; font-size: 13px; font-weight: 600; color: #6b7280; }
.ai-thinking-box__icon { font-size: 14px; }
...
.ai-thinking-box__body { max-height: 300px; overflow-y: auto; font-size: 12.5px; line-height: 1.65; color: #6b7280; word-break: break-word; }
</style>
