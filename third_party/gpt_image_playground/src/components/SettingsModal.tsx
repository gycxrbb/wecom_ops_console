        ...
        <div className="flex flex-1 min-h-0 flex-col sm:flex-row">
          ...
          <div className="flex-1 flex flex-col min-w-0 min-h-0 bg-transparent relative overflow-hidden">
            ...
            {activeTab === 'api' && (
              ...
              {/* 6. API 接口（Images/Responses）—— 嵌入模式下自动路由(画廊→images、agent→responses)，隐藏不让用户选 */}
              {activeProfile.provider === 'openai' && new URLSearchParams(window.location.search).get('embedMode') !== 'true' && (
                <div className="block">
